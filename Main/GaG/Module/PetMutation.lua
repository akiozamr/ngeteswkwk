    ...
    PetMutationRegistry = {
        ...
        MachineMutationTypes = {
            ...
            Shocked = {
                ...
                EnumId = "a",
                Passives = {
                    1 = "Shocked Pet Mutation",
                },
            },
        },
        RollRandomMutation = function: 0xc0a26a1134a121f4,
        PetMutationToEnum = {
            Tranquil = "o",
            Inverted = "g",
            Rideable = "h",
